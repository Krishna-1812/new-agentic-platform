"""/strategic-agents/42-north-dental-slot-checker (page + /data).
...
URL = "/strategic-agents/42-north-dental-slot-checker"
DATA = URL + "/data"
...
OLD = "/strategic-agents/gentle-dental-slot-checker"
...
# AT THE TIME -- "/p2/b2b-agents/...", not "/strategic-agents/..." (and every
# path recorded before 2026-09-24 still carries the old /p2 prefix). OLD
...
def test_the_old_paths_redirect_instead_of_404ing(suffix):
    ...
    assert resp.headers["Location"].endswith(
        "/strategic-agents/42-north-dental-slot-checker" + suffix)
