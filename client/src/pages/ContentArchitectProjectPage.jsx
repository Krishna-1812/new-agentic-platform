      ...
      <div>
        ...
        {spokes.length === 0 ? (
          ...
          <div style={{ borderRadius: 'var(--r-md)', border: '1px solid var(--border)', overflow: 'hidden', marginTop: 8 }}>
            <div style={{ display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 90px 100px', gap: 12, padding: '8px 14px', background: 'var(--surface)', borderBottom: '1px solid var(--border)' }}>
            ...
            {spokes.map((s, i) => {
              ...
              return (
                <div
                  key={s.id}
                  style={{
                    display: 'grid', gridTemplateColumns: 'minmax(0,1fr) 90px 100px', gap: 12, padding: '10px 14px', alignItems: 'center',
