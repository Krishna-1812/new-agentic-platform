...
def _render_html(data_obj: dict, refresh_opts_html: str = "", hiring_opts: dict | None = None) -> str:
    ...
    return (
        ...
        # __BRAND_NAME__ / __BRAND_INITIAL__ are deliberately NOT filled here.
        # They are filled when the file is served (app._send_dashboard_file), so
        # a rename in brand.py reaches a dashboard built last month too.
    )
...
<title>ABM Signal Tracker Dashboard</title>
...
<!-- Sidebar -->
<nav id="sidebar">
  <div class="sidebar-logo"><span>◈</span> ABM Signal Tracker</div>
  ...
  <div class="sidebar-footer">
    ...
    <div class="sidebar-user">
      <!-- The identity block used to be a hard-coded person: one named employee
           of the previous company, rendered as the signed-in user on every
           dashboard, including the one a client portal shows its client. A
           static build cannot know who is viewing, so it names the product. -->
      <div class="sidebar-user-avatar">__BRAND_INITIAL__</div>
      <div class="sidebar-user-info">
        <div class="sidebar-user-name">__BRAND_NAME__</div>
        <div class="sidebar-user-role">Signal Tracker</div>
      </div>
