...
export function AdCard({ ad, onClick, onDomainClick }: AdCardProps) {
  ...
  return (
    <div
      onClick={onClick}
      className="bg-white rounded-2xl overflow-hidden cursor-pointer group shadow-sm transition-all duration-200 border border-slate-100 flex flex-col"
        ...
        {primary ? (
          <>
            <img
              ...
              className="img-fade-in w-full h-full object-cover transition-transform duration-700 ease-out"
